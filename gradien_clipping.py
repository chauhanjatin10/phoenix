...
with tf.name_scope("train"):
	...
	grads_and_vars = optimizer.compute(loss)
	crapped_gvs = [(tf.clip_by_value(grad,-threshold,threshold), var)
				for grad,var in grads_and_vars]
	training_operation = optimizer.apply_gradients(crapped_gvs)
